...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary shadow-inner ">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        >
          <div className="px-5 py-2">
            <Link
              href="/"
              className="text-base text-yellow-100 hover:text-white"
            >
              {t("home")}
            </Link>
          </div>
        ...
        >
          <div className="px-5 py-2">
            <Link href="/Terms03" className="text-yellow-100 hover:text-white">
              {t("jp-terms-01")}
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/Terms02" className="text-yellow-100 hover:text-white">
              {t("jp-terms-02")}
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/Terms01" className="text-yellow-100 hover:text-white">
              {t("jp-terms-03")}
            </Link>
          </div>
        </nav>
      ...
      chatbox.setAttribute("page_id", "101234619188092");
      chatbox.setAttribute("attribution", "biz_inbox");
    </script> */}
        {/* <MessengerCustomerChat pageId="101234619188092" appId="" /> */}
      </div>
    </footer>
  );
};
