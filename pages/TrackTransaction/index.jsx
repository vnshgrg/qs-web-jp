...
const Component = () => {
  ...
  const LoadingComponent = () => {
    return (
      <div className="text-center">
        ...
        <span className="block mt-2 text-blue-500 text-sm ">Loading...</span>
      </div>
    );
  };
  ...
  const ErroComp = ({ txnid }) => (
    <div className="text-center">
      <div>
        <Icon name="circle-x" className="h-8 w-8 text-gray-700 mx-auto" />
      </div>
    ...
    switch (status) {
      case "Cancel":
        return (
          <div className="text-center">
            <div>
              <Icon name="circle-x" className="h-8 w-8 text-red-600 mx-auto" />
            </div>
